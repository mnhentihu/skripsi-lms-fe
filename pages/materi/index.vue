  ...
  <main class="site-materi">
    ...
    <div class="right">
      ...
      <div class="container">
        <div class="content">
          <div
            v-if="dataUser.role == 'Admin' || dataUser.role == 'Guru'"
            class="button-input"
          >
          ...
          <div
            ...
            class="dropdown"
            :class="{
              'is-expanded': selectedDropdown === data.namaMateri,
            }"
          >
            <div class="title">
              ...
              <div class="wrapper">
                ...
                <nuxt-link
                  ...
                  :to="{
                    ...
                    query: { id_Video: dataMateri[index].id },
                  }"
...
export default {
  ...
  mounted() {
    if (localStorage.getItem('loginData')) {
      try {
        this.dataUser = JSON.parse(localStorage.getItem('loginData'))
      } catch (e) {
  ...
  methods: {
    ...
    testIdVideo(index) {
      console.log(this.dataMateri[index])
    },
  },
}
</script>
